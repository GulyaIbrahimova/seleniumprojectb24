...
public class Driver {
    ...
    is not reachable from outside
     We cannot do Driver driver =  new Driver(); compile error, cannot create object of this class
     */
    private Driver(){}
    ...
    public static WebDriver getDriver(){
        ...
        if (driver == null){ //null means it was never initialized, browser was never opened
