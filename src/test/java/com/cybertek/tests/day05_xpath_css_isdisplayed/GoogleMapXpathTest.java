...
public class GoogleMapXpathTest {
    public static void main(String[] args) throws InterruptedException {
        ...
        //click on directions
        WebElement directions = driver.findElement(By.xpath("/html/body/div[3]/div[9]/div[8]/div/div[1]/div/div/div[4]/div[1]/button/span"));
        directions.click();

        Thread.sleep(3000);

        WebElement startingAddressField = driver.findElement(By.xpath("//input[@placeholder='Choose starting point, or click on the map...']"));
        startingAddressField.sendKeys("Kerrigan Ct." + Keys.ENTER);
